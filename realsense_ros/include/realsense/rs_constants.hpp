...
namespace realsense
{
    ...
    const int DEFAULT_ACCEL_FPS = 60;
    const int DEFAULT_GYRO_FPS = 200;
    ...
    const std::map<rs2_stream,
                   std::string>
        MSG_ENCODING = {{RS2_STREAM_COLOR, sensor_msgs::image_encodings::RGB8},
    ...
    const std::map<stream_index_pair,
                   std::string>
        OPTICAL_FRAME_ID = {{COLOR, DEFAULT_COLOR_OPTICAL_FRAME_ID},
