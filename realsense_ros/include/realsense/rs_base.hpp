...
namespace realsense
{
    ...
    protected:
        ...
        Result changeMotionFPS(const stream_index_pair &stream, const rclcpp::Parameter &param);
        ...
        std::map<stream_index_pair, bool> enable_ = {{COLOR, false}, {DEPTH, false}, {INFRA1, false}, {INFRA2, false}, {ACCEL, false}, {GYRO, false}, {FISHEYE1, false}, {FISHEYE2, false}, {POSE, false}};
