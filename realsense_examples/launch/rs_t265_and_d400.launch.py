...
def generate_launch_description():
    ...
    t265_base_frame_id = LaunchConfiguration(
        'base_frame_id', default='t265_link')
    ...
    rviz_config_dir = os.path.join(get_package_share_directory(
        'realsense_examples'), 'config', 'rs_cartographer.rviz')
    ...
    tf_node = Node(
        ...
        arguments=['0', '0', '0.03', '0', '0', '0',
                   t265_base_frame_id, rgbd_base_frame_id]
    )
    t265_node = Node(
